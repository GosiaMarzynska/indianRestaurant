	...
	return (
		<section className={classes.about} id='about-us'>
			...
			<div className={classes.box}>
				<img className={classes.img} src='/assets/chef.jpg' alt='szef kuchni' />
				<p className={classes.text}>
					...
					earum fugit laudantium enim fuga est quod qui excepturi illo neque voluptatum in ipsam, iusto consequuntur
					eveniet dolorum eos molestiae rerum? Ut repudiandae ipsum accusantium iste, totam dolor.{' '}
				</p>
			</div>
		</section>
	);
